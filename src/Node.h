...
private:
    ...
    Element *nbgElements; /// The array containing the indices of all the neigbouring element
    vector<Element> vector_nbgElements; /// This is used to facilitate the operations such as pushing Elemetns, etc.
...
public:
    ...
    void finalize(); /// This is essential to know that the object is completely initialized
